...
export const createTeacher = (data: any) => api.post('/teacher', data);
export const updateTeacher = (id: number, data: any) => api.put(`/teacher/${id}`, data);
...
export const createAttendanceList = (data: any) => api.post('/attendanceList', data);
...
export const updateAttendanceList = (id: number, data: any) => api.put(`/attendanceList/${id}`, data);
...
export const createAttendanceRecord = (listId: number, studentId: number, data: any) =>
...
export const updateAttended = (id: number, data: any) => api.put(`/attendanceRecord/record/${id}`, data);
...
export const createVocabList = (data: any) => api.post('/vocabList', data);
export const getVocabLists = () => api.get('/vocabList/all');
export const updateVocabList = (id: number, data: any) => api.put(`/vocabList/${id}`, data);
...
export const createVocab = (listId: number, data: any) => api.post(`/vocab/list/${listId}`, data);
...
export const addRegistrationList = (data: any) => api.post('/registrationList', data);
...
export const updateRegistrationList = (id: number, data: any) => api.put(`/registrationList/${id}`, data);
...
export const updateUserRole = (id: number, data: any) => api.put(`/user/${id}/role`, data);
